%% Initialize
clear all; close all;
f{1,1} = "https://www2.eecs.berkeley.edu/Research/Projects/CS/vision/grouping/segbench/BSDS300/html/images/plain/normal/color/90076.jpg";
f{1,2} = "https://www2.eecs.berkeley.edu/Research/Projects/CS/vision/grouping/segbench/BSDS300/html/images/plain/normal/color/124084.jpg";
K = 10;
M = 5;
n = size(f, 2);
%%
...
for k = 1:K
    ...
    xv = x(:, indValidate); % Using fold k as validation set
    if k == 1
